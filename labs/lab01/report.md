...
![Распределение вероятностей для каждого n](image/10.png)
...
![График верояностей блокировки по вызовам](image/18.png)
...
![График среднего числа обслуживаемых запросов ](image/20.png)